...
public class ExtAuthHelper {
    ...
    public static final String ACTION_CERT_CONFIGURATION = "my.vpn.openvpn.2x.api.ExternalCertificateConfiguration";
    public static final String ACTION_CERT_PROVIDER = "my.vpn.openvpn.2x.api.ExternalCertificateProvider";

    public static final String EXTRA_ALIAS = "my.vpn.openvpn.2x.api.KEY_ALIAS";
    public static final String EXTRA_DESCRIPTION = "my.vpn.openvpn.2x.api.KEY_DESCRIPTION";
